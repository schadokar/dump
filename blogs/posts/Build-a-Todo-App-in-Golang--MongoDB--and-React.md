...
categories: []
keywords: []
slug: /@shubhamchadokar04/build-a-todo-app-in-golang-mongodb-and-react-e1357b4690a6
---

![Google sources](https://cdn-images-1.medium.com/max/1200/1*ZUuS_BuHEMz_QmlSPl0vSg.png)
Google sources
...
![Whitelist IP address](https://cdn-images-1.medium.com/max/1200/1*C7nfL2-4BU4v2DlpuxRtow.png)
...
![atlas user](https://cdn-images-1.medium.com/max/1200/1*AbdyOLCDGCDb57YKSU2sQQ.png)
atlas user
...
![connection string](https://cdn-images-1.medium.com/max/1200/1*QP82h8R88HQz_ZOQ_hRS2Q.png)
connection string
...
![serve](https://cdn-images-1.medium.com/max/1200/1*1_KkZ3GUIhHTdPJhRty98w.png)
serve
...
![index](https://cdn-images-1.medium.com/max/800/1*mG0ltuzwIK6oI5_QwT_RPw.png)
index

*   **Create tasks**

![Create Task](https://cdn-images-1.medium.com/max/800/1*tDNWhYD0JFqqMOiTPWda5Q.png)
Create Task

*   **Complete task by clicking** `Done`

![Task Complete](https://cdn-images-1.medium.com/max/800/1*lurpOVw4FdwM4M6KiDcThw.png)
Task Complete

*   **Undo a task**

![Undo Task](https://cdn-images-1.medium.com/max/800/1*tDNWhYD0JFqqMOiTPWda5Q.png)
Undo Task

*   **Delete Task**

![Delete Task](https://cdn-images-1.medium.com/max/800/1*66XhCBq44x79SjFcLnAmUg.png)
Delete Task
